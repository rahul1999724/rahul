...
def save_file(event=None):
    ...
    try:
        if url:
            ...
            url = filedialog.asksaveasfile(mode='w', defaultextension='.txt',filetypes=(('Text File', '*.txt'),('All File','*.txt')))
...
edit.add_command(label='Clear_all', image=clear_all_icon, compound=tk.LEFT, accelerator='ctrl+Alt+X',command=lambda:text_editor.delete(1.0,tk.END))   ### 02:36 time
